...
public class MainFragment extends Fragment {
    ...
    private View.OnClickListener mOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            int i = v.getId();
            if (i == R.id.buttonStartRecording) {
                v.setEnabled(false);
                tryStart();

            } else if (i == R.id.buttonPauseRecording) {
                v.setEnabled(false);
                pause(false);

            } else if (i == R.id.buttonPlayRecording) {
                play();
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mStopButton = (Button) view.findViewById(R.id.buttonstop);
    ...
    private String getNextFileName() {
        ...
        return MyFileUtils.before_path + "/Record_"
    ...
    private void play() {
        ...
        if (file.exists()) {
            VoideUtils.VideoPlay(getContext(),file);
        }
    }
